 ...
 */
final class Version20260717165527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE d_accounting (id VARCHAR(255) NOT NULL, parent_id VARCHAR(255) DEFAULT NULL, x_timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, date_created DATETIME NOT NULL, name LONGTEXT DEFAULT NULL, in_no VARCHAR(255) DEFAULT NULL, invoice VARCHAR(255) DEFAULT NULL, date_invoice DATETIME DEFAULT NULL, date_discarded DATETIME DEFAULT NULL, discarded TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_3588D169727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_device (id VARCHAR(255) NOT NULL, parent_id VARCHAR(255) DEFAULT NULL, group_id VARCHAR(255) DEFAULT NULL, type_id VARCHAR(255) DEFAULT NULL, accounting_id VARCHAR(255) DEFAULT NULL, file_id INT DEFAULT NULL, created_by INT DEFAULT NULL, modified_by INT DEFAULT NULL, x_timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, date_created DATETIME NOT NULL, code VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, sn VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, log LONGTEXT DEFAULT NULL, sort INT DEFAULT 100, INDEX IDX_5CF3FF5B727ACA70 (parent_id), INDEX IDX_5CF3FF5BFE54D947 (group_id), INDEX IDX_5CF3FF5BC54C8C93 (type_id), UNIQUE INDEX UNIQ_5CF3FF5B3B7DD068 (accounting_id), UNIQUE INDEX UNIQ_5CF3FF5B93CB796C (file_id), INDEX IDX_5CF3FF5BDE12AB56 (created_by), INDEX IDX_5CF3FF5B25F94802 (modified_by), UNIQUE INDEX UNIQ_5CF3FF5BFE54D94777153098 (group_id, code), UNIQUE INDEX UNIQ_5CF3FF5BC54C8C93EFC17495 (type_id, sn), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_device_image (device_id VARCHAR(255) NOT NULL, file_id INT NOT NULL, INDEX IDX_125DB9E694A4C7D4 (device_id), INDEX IDX_125DB9E693CB796C (file_id), PRIMARY KEY(device_id, file_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_device_history (id VARCHAR(255) NOT NULL, device_id VARCHAR(255) NOT NULL, parent_id VARCHAR(255) NOT NULL, x_timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, date_placement DATETIME NOT NULL, execute DATETIME DEFAULT NULL, INDEX IDX_A76D7DEB94A4C7D4 (device_id), INDEX IDX_A76D7DEB727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_device_license (id VARCHAR(255) NOT NULL, device_id VARCHAR(255) NOT NULL, license_software_id VARCHAR(255) NOT NULL, software_id VARCHAR(255) NOT NULL, key_id VARCHAR(255) NOT NULL, INDEX IDX_D7BFF9B994A4C7D4 (device_id), INDEX IDX_D7BFF9B9F5503E07 (license_software_id), INDEX IDX_D7BFF9B9D7452741 (software_id), INDEX IDX_D7BFF9B9D145533 (key_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_device_location (id VARCHAR(255) NOT NULL, device_id VARCHAR(255) NOT NULL, x_timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, date DATE NOT NULL, place VARCHAR(255) NOT NULL, responsible VARCHAR(255) NOT NULL, INDEX IDX_88C8FD2E94A4C7D4 (device_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_device_property (id VARCHAR(255) NOT NULL, device_id VARCHAR(255) NOT NULL, sub_device_id VARCHAR(255) DEFAULT NULL, property_id VARCHAR(255) NOT NULL, value VARCHAR(255) DEFAULT NULL, value_s VARCHAR(255) DEFAULT NULL, value_n DOUBLE PRECISION DEFAULT NULL, INDEX IDX_5DA4683B94A4C7D4 (device_id), INDEX IDX_5DA4683B86A9816A (sub_device_id), INDEX IDX_5DA4683B549213EC (property_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_device_property_enum (device_property_id VARCHAR(255) NOT NULL, enum_id VARCHAR(255) NOT NULL, INDEX IDX_AA9C5E942612472A (device_property_id), INDEX IDX_AA9C5E9417628E55 (enum_id), PRIMARY KEY(device_property_id, enum_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_device_repair (id VARCHAR(255) NOT NULL, device_id VARCHAR(255) NOT NULL, put_into DATE NOT NULL, received_from DATE DEFAULT NULL, closed TINYINT(1) DEFAULT 0 NOT NULL, reason LONGTEXT NOT NULL, repairman VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_3C8E5FB494A4C7D4 (device_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_license (id VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, aut_no VARCHAR(255) DEFAULT NULL, no VARCHAR(255) DEFAULT NULL, date_real DATETIME DEFAULT NULL, sort INT DEFAULT 100, UNIQUE INDEX UNIQ_A1840E0B77153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_license_key (id VARCHAR(255) NOT NULL, license_software_id VARCHAR(255) NOT NULL, software_id VARCHAR(255) NOT NULL, type_key VARCHAR(191) DEFAULT 'VLK' NOT NULL, value VARCHAR(255) DEFAULT NULL, actived VARCHAR(255) DEFAULT NULL, INDEX IDX_E45AD669F5503E07 (license_software_id), INDEX IDX_E45AD669D7452741 (software_id), UNIQUE INDEX UNIQ_E45AD669F5503E07D745274188874D48 (license_software_id, software_id, type_key), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_license_software (id VARCHAR(255) NOT NULL, license_id VARCHAR(255) NOT NULL, software_id VARCHAR(255) NOT NULL, count INT DEFAULT NULL, INDEX IDX_60D6ADEA460F904B (license_id), INDEX IDX_60D6ADEAD7452741 (software_id), UNIQUE INDEX UNIQ_60D6ADEA460F904BD7452741 (license_id, software_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_property (id VARCHAR(255) NOT NULL, parent_id VARCHAR(255) DEFAULT NULL, type_id VARCHAR(255) DEFAULT NULL, prototype_id VARCHAR(255) DEFAULT NULL, x_timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, date_created DATETIME NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, active TINYINT(1) DEFAULT 1 NOT NULL, active_from DATETIME DEFAULT NULL, active_to DATETIME DEFAULT NULL, required TINYINT(1) DEFAULT 0 NOT NULL, multiple TINYINT(1) DEFAULT 0 NOT NULL, field_type VARCHAR(255) DEFAULT 'S' NOT NULL, list_type VARCHAR(255) DEFAULT 'S' NOT NULL, default_value VARCHAR(255) DEFAULT NULL, postfix VARCHAR(255) DEFAULT NULL, prefix VARCHAR(255) DEFAULT NULL, sort INT DEFAULT 100, description LONGTEXT DEFAULT NULL, INDEX IDX_78BD816C727ACA70 (parent_id), UNIQUE INDEX UNIQ_78BD816CC54C8C93 (type_id), INDEX IDX_78BD816C25998077 (prototype_id), UNIQUE INDEX UNIQ_78BD816C727ACA7077153098 (parent_id, code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_property_enum (id VARCHAR(255) NOT NULL, property_id VARCHAR(255) DEFAULT NULL, x_timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, `default` TINYINT(1) DEFAULT 0 NOT NULL, value VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, sort INT DEFAULT 100 NOT NULL, INDEX IDX_70DC0BE5549213EC (property_id), UNIQUE INDEX UNIQ_70DC0BE5549213EC1D775834 (property_id, value), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_software (id VARCHAR(255) NOT NULL, parent_id VARCHAR(255) DEFAULT NULL, type_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, sort INT DEFAULT 100, UNIQUE INDEX UNIQ_849FF57D5E237E06 (name), INDEX IDX_849FF57D727ACA70 (parent_id), INDEX IDX_849FF57DC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_software_type (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, sort INT DEFAULT 100, UNIQUE INDEX UNIQ_C8A1475B77153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_type (id VARCHAR(255) NOT NULL, parent_id VARCHAR(255) DEFAULT NULL, property_id VARCHAR(255) DEFAULT NULL, active TINYINT(1) DEFAULT 1 NOT NULL, active_from DATETIME DEFAULT NULL, active_to DATETIME DEFAULT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, sort INT DEFAULT 100, description LONGTEXT DEFAULT NULL, INDEX IDX_357E3CC0727ACA70 (parent_id), UNIQUE INDEX UNIQ_357E3CC0549213EC (property_id), UNIQUE INDEX UNIQ_357E3CC0727ACA7077153098 (parent_id, code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE d_type_property (type_id VARCHAR(255) NOT NULL, property_id VARCHAR(255) NOT NULL, INDEX IDX_277721ACC54C8C93 (type_id), INDEX IDX_277721AC549213EC (property_id), PRIMARY KEY(type_id, property_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE d_device ADD CONSTRAINT FK_5CF3FF5B727ACA70 FOREIGN KEY (parent_id) REFERENCES d_device (id) ON DELETE RESTRICT
        SQL);
        $this->addSql(<<<'SQL'
