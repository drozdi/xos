...
final class Version20260817150000 extends AbstractMigration
{
    ...
    {
        if (!$this->tableExists('board_checklist')) {
        ...
        if (!$this->tableExists('board_checklist_item')) {
        ...
        if (!$this->tableExists('board_attachment')) {
        ...
        if (!$this->tableExists('board_comment')) {
        ...
        if (!$this->tableExists('board_activity_log')) {
        ...
        if (!$this->foreignKeyExists('board_checklist', 'FK_board_checklist_card')) {
        ...
        if (!$this->foreignKeyExists('board_checklist_item', 'FK_board_checklist_item_checklist')) {
        ...
        if (!$this->foreignKeyExists('board_attachment', 'FK_board_attachment_card')) {
        ...
        if (!$this->foreignKeyExists('board_attachment', 'FK_board_attachment_uploaded_by')) {
        ...
        if (!$this->foreignKeyExists('board_comment', 'FK_board_comment_card')) {
        ...
        if (!$this->foreignKeyExists('board_comment', 'FK_board_comment_user')) {
        ...
        if (!$this->foreignKeyExists('board_activity_log', 'FK_board_activity_log_board')) {
        ...
        if (!$this->foreignKeyExists('board_activity_log', 'FK_board_activity_log_card')) {
        ...
        if (!$this->foreignKeyExists('board_activity_log', 'FK_board_activity_log_user')) {
