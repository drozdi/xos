...
final class Version20260817140000 extends AbstractMigration
{
    ...
    {
        if (!$this->tableExists('board_list')) {
        ...
        if (!$this->tableExists('board_card')) {
        ...
        if (!$this->tableExists('board_label')) {
        ...
        if (!$this->tableExists('board_card_label')) {
        ...
        if (!$this->tableExists('board_card_assignee')) {
        ...
        if (!$this->foreignKeyExists('board_list', 'FK_board_list_board')) {
        ...
        if (!$this->foreignKeyExists('board_list', 'FK_board_list_assignee')) {
        ...
        if (!$this->foreignKeyExists('board_card', 'FK_board_card_list')) {
        ...
        if (!$this->foreignKeyExists('board_card', 'FK_board_card_created_by')) {
        ...
        if (!$this->foreignKeyExists('board_label', 'FK_board_label_board')) {
        ...
        if (!$this->foreignKeyExists('board_card_label', 'FK_board_card_label_card')) {
        ...
        if (!$this->foreignKeyExists('board_card_label', 'FK_board_card_label_label')) {
        ...
        if (!$this->foreignKeyExists('board_card_assignee', 'FK_board_card_assignee_card')) {
        ...
        if (!$this->foreignKeyExists('board_card_assignee', 'FK_board_card_assignee_user')) {
