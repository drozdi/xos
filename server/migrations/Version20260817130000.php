...
final class Version20260817130000 extends AbstractMigration
{
    ...
    {
        if (!$this->tableExists('board_workspace')) {
        ...
        if (!$this->tableExists('board_workspace_member')) {
        ...
        if (!$this->tableExists('board_board')) {
        ...
        if (!$this->tableExists('board_board_member')) {
        ...
        if (!$this->foreignKeyExists('board_workspace', 'FK_board_workspace_owner')) {
        ...
        if (!$this->foreignKeyExists('board_workspace_member', 'FK_bwm_workspace')) {
        ...
        if (!$this->foreignKeyExists('board_workspace_member', 'FK_bwm_user')) {
        ...
        if (!$this->foreignKeyExists('board_workspace_member', 'FK_bwm_invited_by')) {
        ...
        if (!$this->foreignKeyExists('board_board', 'FK_board_board_workspace')) {
        ...
        if (!$this->foreignKeyExists('board_board', 'FK_board_board_created_by')) {
        ...
        if (!$this->foreignKeyExists('board_board_member', 'FK_bbm_board')) {
        ...
        if (!$this->foreignKeyExists('board_board_member', 'FK_bbm_user')) {
