...
#[Route('/api/schooltask/auth', name: 'api_schooltask_auth_')]
class AuthController extends AbstractController
{
    ...
    /**
     * Реальный вход обрабатывает firewall schooltask_login (json_login).
     */
    #[Route('/login', name: 'login', methods: ['POST'])]
    public function login(): never
    {
        throw new \LogicException('SchoolTask login is handled by the security firewall.');
    }
    ...
    {
        return $this->json([
            'hint' => 'POST /api/schooltask/auth/login with JSON {"username":"<email>","password":"..."}',
        ]);
    }
