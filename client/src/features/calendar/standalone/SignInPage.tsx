...
import { calendarEmailLogin } from './authApi';

export function CalendarSignInPage() {
	...
	const handleSubmit = async (values: { username: string; password: string }) => {
		setLoading(true);
		try {
			const ok = await calendarEmailLogin(values.username, values.password);
			if (ok) {
